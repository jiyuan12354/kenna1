        ...
        <div class="home">
            ...
            <div class="hero animated fadeIn">
                ...
                <div id='intro'>
                    ...
                    <p>壹起創建您的移動應用程序</p>
                    <p>我們設計和開發了多款應用產品，包括網站，小程序，手機app</p>
                    <p>我們構思和創建成功軟件的基礎就是以用戶為中心的互動設計和體驗</p>
                </div>
            ...
            <div class="intro">
                ...
                <ul class="value">
                    ...
                    <li>提高用戶的粘度，留住新老客戶，讓他們成為中最好的口碑傳播者。</li>
